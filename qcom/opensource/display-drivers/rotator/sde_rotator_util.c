...
static __maybe_unused void *sde_rot_dmabuf_no_map(struct dma_buf *buf, unsigned long n)
{
	SDEROT_WARN("NOT SUPPORTING dmabuf map\n");
	return NULL;
}

static __maybe_unused void sde_rot_dmabuf_no_unmap(struct dma_buf *buf, unsigned long n,
		void *addr)
{
